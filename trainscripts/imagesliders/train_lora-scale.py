...
#                 1, 25, (1,)
            ...
            img1 = Image.open(f'{folder_main}/{folder1}/{ims[random_sampler]}').resize((256,256)).convert('RGB')
            img2 = Image.open(f'{folder_main}/{folder2}/{ims[random_sampler]}').resize((256,256)).convert('RGB')
